...
class _NotificationCenterScreenState extends State<NotificationCenterScreen> {
      ...
      appBar: AppBar(
        ...
        title: Row(children: [
          Container(
            ...
            child: const Icon(Icons.notifications_rounded, color: Colors.white, size: 15),
          ),
          const SizedBox(width: 10),
          Text('Bildirim Merkezi', style: TextStyle(color: tp, fontSize: 16,
  ...
  Color _typeColor(String type) {
    switch (type) {
      case 'location':
      case 'geofence':   return AppColors.info;
      case 'reminder':   return AppColors.warn;
      case 'done':       return AppColors.success;
      case 'cancelled':  return AppColors.textSecond(context);
      case 'general':    return AppColors.orange;
  ...
  IconData _typeIcon(String type) {
    switch (type) {
      case 'location':
      case 'geofence':   return Icons.location_on_rounded;
